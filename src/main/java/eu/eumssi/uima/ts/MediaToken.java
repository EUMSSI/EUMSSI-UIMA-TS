...
public class MediaToken extends Token {
  ...
  */  
  ...
  public double getConfidence() {
    if (MediaToken_Type.featOkTst && ((MediaToken_Type)jcasType).casFeat_confidence == null)
      jcasType.jcas.throwFeatMissing("confidence", "eu.eumssi.uima.ts.MediaToken");
    return jcasType.ll_cas.ll_getDoubleValue(addr, ((MediaToken_Type)jcasType).casFeatCode_confidence);}
  ...
  public void setConfidence(double v) {
    if (MediaToken_Type.featOkTst && ((MediaToken_Type)jcasType).casFeat_confidence == null)
      jcasType.jcas.throwFeatMissing("confidence", "eu.eumssi.uima.ts.MediaToken");
    jcasType.ll_cas.ll_setDoubleValue(addr, ((MediaToken_Type)jcasType).casFeatCode_confidence, v);}    
  }
